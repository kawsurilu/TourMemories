...
import { IStatus, Status, PrivacyCategories, PinnedPostCategories } from 'app/shared/model/status.model';
...
describe('Service Tests', () => {
  describe('Status Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Status(0, 'AAAAAAA', PrivacyCategories.PUBLIC, PinnedPostCategories.PINNED, 'AAAAAAA');
    });
